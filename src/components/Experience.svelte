  ...
  const experiences: IExperience[] = [
    {
      ...
      employerImage: TAMUHealthLogo,
      location: "Bryan, Texas",
      duration: "Present",
      description: `Contributed to the development of OliviaHealth, a grant funded project lead by the Texas A&M Health Science Center to alleviate maternal and familial care.
        ...
        Optimized data flow, ensuring data consistency and reliable communication channels between font and backend systems.
    ...
    },
    {
      ...
      employerImage: TAMULogo,
      location: "College Station, Texas",
      duration: "Present",
      description: `Provided regular, one-on-one peer academic coaching to students who live on campus
    ...
    },
    {
      ...
      description: `
            ...
            Held weekly stand-up meetings to discuss progress, update team on goals and held mini-lessons covering various technologies.Led a team of 20+ students to create a cross platform mobile app at Texas A&M University to connect new students with similar interests. Implemented mobile technologies including React Native and TypeScript and backend technologies including Node.js, Express.js and Google Firebase. Created a REST API to relay information from frontend client to backend server to Google Firestore database. Taught team members how to use Git, React Native, TypeScript, Firebase etc… Held weekly stand-up meetings to discuss progress, update team on goals and held mini-lessons covering various technologies.
    `,
    },
    {
      title: "Front End Software Engineer",
      employer: "Crypt",
      employerImage: CryptLogo,
      location: "Austin, Texas",
      duration: "3 Months",
      description: `Designed and developed Crypt’s front-end web application to securely encrypt, store and retrieve user data on the IPFS network using SHA-256 and AES block cipher.
...
<main>
  <h2 class="text-2xl font-semibold mb-2 ml-2">Experience</h2>

  <div class="flex">
    <div class="w-2/3">
      {#each experiences as experience}
        <div
          class="flex items-center gap-4 w-full text-sm p-2 my-4 rounded-xl hover:bg-secondary"
        >
          <img
          ...
          />
          <p class="w-1/2">{experience.title}</p>
